# Generated by Django 4.2.17 on 2025-04-25 07:34
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                help_text="'/here/is/the/your/refer/' after the 3 before and equals 100 symbols",
                max_length=100,
                unique=True,
                validators=[
                    ...
                    django.core.validators.MinLengthValidator(
                        limit_value=1, message="Min length (of path) 3 symbols"
                    ),
                    django.core.validators.RegexValidator(
                        message="The path has the invalid format",
                        regex="^(?!.*  )\\/*[a-zA-Zа-яА-ЯёЁ][\\w \\-_\\dа-яА-ЯёЁ]{1,48}\\\n[a-zA-Zа-яА-ЯёЁ]$[^\\S\\W \\\\]?",
                    ),
                ],
